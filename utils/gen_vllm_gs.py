...
# for model_path in [
#     # "output-cms3-rank/3e-4/v0-20250410-172624/checkpoint-3459-merged",
#     # "output-cms3-rank/3e-4/v1-20250410-205905/checkpoint-3459-merged",
#     # "output-cms3-rank/3e-4/v2-20250411-003137/checkpoint-3459-merged",
#     # "output-cms3-rank/3e-4/v3-20250411-040342/checkpoint-3459-merged",
#     # "output-cms3-rank/3e-4/v4-20250411-073614/checkpoint-3459-merged",
#     # "output-cms3-rank/3e-4/v5-20250411-110907/checkpoint-3459-merged",
...
name = re.findall(r"output-cms3-rank/3e-4/(v.*)-2025", args.model)[0]
print(args.model)
args.output_file = os.path.join("/common-data/zhanghaojie/DropLora/output/llama2_7b/cms_rank",
                                name + '.jsonl')
