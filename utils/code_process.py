...
parser.add_argument(
    '--path',
    type=str,
    default='output/llama3_8b/python/python_r32_a64_e3_droplora_inner_0.1.jsonl',
    help="")
parser.add_argument(
    '--out_path',
    type=str,
...
import os
humaneval_outpath = os.path.join(os.path.dirname(args.path), "humaneval_" + os.path.basename(args.path))
mbpp_outpath = os.path.join(os.path.dirname(args.path), "mbpp_"+ os.path.basename(args.path))
