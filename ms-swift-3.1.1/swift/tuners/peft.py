...
from peft import (AdaLoraConfig, BOFTConfig, BOFTModel, LoftQConfig, LoHaConfig, LoKrConfig, LoraModel, OFTConfig,
                  ...
                  PromptEncoderConfig, PromptLearningConfig, PromptTuningConfig, VeraConfig, VeraModel, MdraConfig, MdraModel, DropLoraConfig, DropLoraModel, get_peft_config,
...
def hot_patch_peft_module():
    ...
    MdraModel._create_and_replace_origin = MdraModel._create_and_replace
    MdraModel._create_and_replace = _create_and_replace_hook
    DropLoraModel._create_and_replace_origin = DropLoraModel._create_and_replace
    DropLoraModel._create_and_replace = _create_and_replace_hook
...
MdraConfig = wrap_module(MdraConfig)
DropLoraConfig = wrap_module(DropLoraConfig)
OFTConfig = wrap_module(OFTConfig)
