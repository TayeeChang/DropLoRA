...
class TunerArguments:
    ...
    # Mdra
    mdra_rank: int = 256
    mdra_dropout: float = 0.0
    mdra_d_initial: float = 0.1
    mdra_init_weights: Literal[True, "missa", "pissa"]=True

    # DropLora
    droplora_inner_dropout: float = 0.5
    droplora_dynamic_pruning: bool = False
