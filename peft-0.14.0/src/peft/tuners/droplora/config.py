...
@dataclass
class DropLoraConfig(PeftConfig):
    """
    ...
    inner_dropout: float = field(default=0.5, metadata={"help": "Lora dropout"})
    dynamic_pruning: bool = field(
        default=False,
        metadata={"help": "whether to use dynamic pruning"},
    )
    ...
    def __post_init__(self):
        super().__post_init__()
        self.peft_type = PeftType.DROPLORA
        self.target_modules = (
