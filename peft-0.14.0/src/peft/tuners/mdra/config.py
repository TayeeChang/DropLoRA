...
class MdraConfig(PeftConfig):
    ...
    d_initial: float = field(default=1., metadata={"help": "Initial init value for d vector."})
    ...
    init_weights: (bool | Literal["pissa", "missa"]) = field(
        default=True,
        metadata={
            "help": (
